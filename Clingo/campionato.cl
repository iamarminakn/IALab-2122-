...
%20 {assegna(S,G):giornata(G)} 20:-team(S,_).
...
:- game(S1,C,G), game(S2,C1,G), S1 != S2, team(S1,C), team(S2,C).
...
%non è possibile che una squadra affronti due volte un'altra squadra
